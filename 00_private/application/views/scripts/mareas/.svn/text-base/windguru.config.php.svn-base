...
$WG_config['id_user']    = '1135176'; // YOUR WINDGURU USER ID (IF YOU DO NOT REMEMBER YOUR ID, SEE YOUR SETTINGS PAGE ON WINDGURU.CZ)

$WG_config['lang']    = 'es'; // DEFAULT LANGUAGE VERSION, possible values:
//    'en' = english (default), 
//    'cz' = czech
//    'de' = german
//    'fr' = french
...
// if you use 'file':
$WG_config['cache_dir']                 = '/var/www/virtual/balneario-el-condor.com.ar/cache_windguru'; // your file cache directory (default '.' = current directory)
...
$WG_config['cache_mysql_user']          = 'root'; // mysql database username
$WG_config['cache_mysql_password']      = 'borjas'; // mysql database password
$WG_config['cache_mysql_dbname']        = 'windguru'; // name of your mysql database 
