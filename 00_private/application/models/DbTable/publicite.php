...
class Application_Model_DbTable_publicite extends Zend_Db_Table_Abstract
{
    ...
    public function setPu_fecha($pu_fecha){
        $this->_pu_fecha = (isset($pu_fecha))?$pu_fecha:"";
    }
    
    public function getPu_fecha(){
        return $this->_pu_fecha;
    }
    ...
    public function setOptions(array $options){
        ...
        $this->setPu_fecha($options["pu_fecha"]);
