...
if(! defined('CURL_TIMEOUT') )                          define ('CURL_TIMEOUT', 100);                                                    // Timeout duration for Curl. This only applies if you have Curl installed and aren't using PHP's default URL fetching mechanism.
...
if(! isset($ALLOWED_SITES)){
        $ALLOWED_SITES = array (
                ...
                'imageshack.us',
                'tinypic.com',
                'static.balneario-el-condor.com.ar',
                'local.sandroblog.com.ar',
                'sandro-fogel.balneario-el-condor.com.ar',
        		'neoworkshop.fidegroup.com.ar',
        		'static.guia.clarin.com'
        );
}
// -------------------------------------------------------------
