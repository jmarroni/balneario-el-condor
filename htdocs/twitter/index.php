...
class ezTweet {
   ...
   // Enter your Twitter App Consumer Key between the '' signs
	private $consumer_key = 'NVLZntmqN4GMUdBOJxd2S4Qn1';

	// Enter your Twitter App Consumer Secret between the '' signs
	private $consumer_secret = 'vaopRwYqqsE8izm8m4IONyoUftGWdW4WZ1oMKI5CyaCXSmCL9O';

	// Enter your Twitter App Access Token between the '' signs
	private $user_token = '1042959182-x0x7u1KU1rppY7u6PVRiwbF0MTGFQ8bXX2BdVE6';

	// Enter your Twitter App Access Token Secret between the '' signs
	private $user_secret = 'jIxNjnDnkIlMByGVkCi18qnMXWz7qBMyXQh5H2WaHwPIv';
