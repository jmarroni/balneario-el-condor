...
include('/min?f=/js/superfish.js,/js/jquery.mobilemenu.js,/js/jquery.easing.1.3.js,/js/jquery.cookie.js,/js/jquery.tipsy.js')
...
if($.fn.bxSlider)
	$('#carousel-1-alojamiento').bxSlider({ 
	   minSlides: 1,
	   maxSlides: 3,
	   move: 1,
	   slideWidth: 270,
	  ...
	  hideControlOnEnd: false,    
	   pager: false,
	   nextSelector: '.next-alojamiento',
	   prevSelector: '.prev-alojamiento'   
...
// custom select
  ...
  jQuery(document).ready(function(){
    ...
    $(function(){
      ...
      rMenu.openCloseSubMenu = function(c){
        var self = $(this);
      ...
      cf.on("submit",function(event){
        ...
        request.then(function(data){
          if(data == "1"){
            ...
            text = "Su mensaje se envió satifactoriamente, nos pondremos en contacto con ud.!";
            ...
            if(cf.find('textarea').val().length < 20){
              text = "El mensaje debe contener al menos 20 caracteres!"
            }
            if(cf.find('input').val() == ""){
              text = "Todas los campos son obligatorios!";
            }
            if($('#captcha').val() !=""  && $('#captcha').val() != "8"){
    ...
    (function(){
      ...
      subscribe.on('submit',function(e){
        ...
        if(self.find('input[type="email"]').val() == ''){
          ...
          $.ajax({
            type: "POST",
            url: "/newsletter/suscripcion",
            data: self.serialize(), 
            success: function(data){
              if(data == '1'){
                text = "Se ha ingresado correctamente el mail en la base de datos, pronto tendra noticias nuestras!";
